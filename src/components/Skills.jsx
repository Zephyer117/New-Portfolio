                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            num="1"
                            title="Ui/Ux Design"
                            desc="We Create UI/UX design using figma adobe xd based on different preferences and choices. Be it e-commerce, portfolio, personal we can edit and present as you prefer"
                            data={[
                                "AI & PS",
                                "Wireframe",
                                "Adobe XD",
                        ...
                        <Service
                            ...
                            desc="Be it for your website or your personal social media we can do the editing for your video. We can offer you professional level editing also if you want ai generated stuff we got you covered as well."
                            data={[
                                "After Effect",
                                "Adobe Illustrator",
                                "Motion 3d",
                        ...
                        <Service
                            ...
                            desc="I will provide you FrontEnd Development as you desire or have record. We build based on client order and how they prefer"
                            data={[
                                "React",
                                "Next JS",
                                "User Experience",
