      ...
      <Wrapper>
        ...
        >
          <div className="font-light mb-4">
            👋 Hi, I Am <span className="font-semibold">Utsho</span>
          </div>
          <div className="max-w-[510px]">
            I create and maintain modern websites and applications also help in
            designing sector. I will try my best to solve all your website and
            desgining. And I will give you services requiring on your need.
          </div>
        </motion.div>
        {/* INTRO END */}
